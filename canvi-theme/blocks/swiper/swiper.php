  ...
  <div class="swiper swiper-container favorites-swiper-container">
    <div class="swiper-wrapper">
      ...
      while ( $parcela_query->have_posts() ) : $parcela_query->the_post();
        ...
        echo '<div class="swiper-slide" data-id="' . get_the_permalink() . '"'.$style.'><div class="slide-sub"><a href="' . get_the_permalink() . '" title="' . $title . '">' . $title . '</a><br><span class="ha">Superficie: ' . $ha . ' [ha]</span><br><span class="ha">Subzona: ' . $subzona . '</span></div></div>';
      endwhile; 
      ?>
